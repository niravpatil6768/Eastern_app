...
const Login = () => {
  ...
  return (
    <Grid container>
      <Grid lg={4.5} md={4.5} sx={Style.grid}></Grid>
      <Grid lg={7.5} md={7.5} sm={12} xs={12} sx={{ padding: "0 10px" }}>
        ...
        <Grid container sx={Style.grid1}>
          <Paper sx={Style.paper}>
            ...
            >
              <Typography style={{ fontSize: "1.8rem" }}>Sign In</Typography>
              <Typography
                style={{
                  fontSize: "1.1rem",
                  whiteSpace: "nowrap",
            ...
            >
              <Grid container sx={Style.grid2}>
                ...
                <Button type="submit" fullWidth sx={Style.button}>
                  <Typography style={{ fontSize: "1.2rem", fontWeight: "" }}>
                    Login
                  </Typography>
                </Button>
              </Grid>
